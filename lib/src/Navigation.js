...
class Navigation {
  ...
  registerContainer(containerName, getContainerFunc, Provider, store) {
    this.containerRegistry.registerContainer(containerName, getContainerFunc, Provider, store);
  }
  ...
  setupHeader(containerId, config) {
    return this.commands.setupHeader(containerId, config);
  }
